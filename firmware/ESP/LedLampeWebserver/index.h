         ...
         <div class="setModal-body">
            <div class="settingFields">
               <form>
                  <fieldset id="group1">
                     WLAN Mode: <br>
                     AccessPoint Mode <input id="wifiModeAP" type="radio" value="WIFI_AP" name="wifiBTN" checked="checked">
                     Station Mode <input id="wifiModeST" type="radio" value="WIFI_STA" name="wifiBTN">
                  </fieldset>
                  <table>
                     <tr>
                        <td>IP-Adresse: </td>
